...
import {API_URL,EMPLOYEE_PROFILE,EMPLOYEE_PROFILE_UPDATE,EMPLOYEE_PROFILE_PERSONAL_UPDATE,USER_PROFILE_TAX_UPDATE,CORE,USER_PROFILE_BANK_UPDATE ,ADMIN_PROFILE_UPDATE} from '../Contants';
...
import $ from 'jquery';
 ...
 export default class Profile extends Component {
   constructor(props){
     ...
     this.changeSalaryType = this.changeSalaryType.bind(this);
     this.changeSalary = this.changeSalary.bind(this);
     this.changePaymentType = this.changePaymentType.bind(this);

     this.changeScpAcNo = this.changeScpAcNo.bind(this);
     this.changeTapAcNo = this.changeTapAcNo.bind(this);
     ...
     this.changeScpcon = this.changeScpcon.bind(this);
     ...
     this.changeAleave = this.changeAleave.bind(this);
     this.changeRAleave = this.changeRAleave.bind(this);
   ...
   async loadUser(){
     var fetchData = await fetch(API_URL + EMPLOYEE_PROFILE + this.props.match.params.id).then(res => res.json());
     if(fetchData.code === 200)
     {
       var employee = fetchData.data['employee']
       var personal_info = fetchData.data['personal_info'];
       var emergency_contacts = employee.emergency_contacts !== 'null' ? employee.emergency_contacts : [] ;
      ...
      //  return;
       ...
       if(members !== null){
        ...
        this.setState({
          members : members,
          members2 : members.length < 0 ? [{index : 0}] : members
        });
       }
       if(bank_details !== null){
        ...
        //  document.querySelector('#ifsc').value = bank_details.ifsc_code;
        //  document.querySelector('#panno').value = bank_details.pan_no;
       }
       if(emergency_contacts !== null && emergency_contacts !== 'null'){
       ...
       if(personal_info)
       {
        ...
        //   userId : employee.id,
          ...
          tapacno : employee.tap,
          scpacno : employee.scp,
          tapcon : employee.tapper,
          scpcon : employee.scpper,
          foreigner : employee.foreigner,
          aleave : employee.holiday
   ...
   changeTapAcNo(event){
    this.setState({tapacno : event.target.value});
   }

   changeScpAcNo(event){
    this.setState({scpacno : event.target.value});
   }
  ...
  changeAleave(event){
    this.setState({aleave : event.target.value});
  }

  changeRAleave(event){
    this.setState({raleave : event.target.value});
  }
  ...
  changeScpcon(event){
    this.setState({scpcon : event.target.value});
  }
  ...
  async updateProfile(e){
    ...
    const {foreigner,doj,notes,salary,father,name,email,address,mobile,designation,pincode,state,country,sex,facebook, twitter, github,linkedin, aleave,raleave} = this.state;
    ...
    if(pincode === '' || pincode === null){
        this.setState({pincodeError : 'Field is required.'});
        error = true;
    }
    ...
    formData.append('foreigner', this.state.foreigner);
    ...
    formData.append('holiday' , aleave);
    formData.append('remain_holiday' , raleave);
    ...
    var fetchData =  await fetch(API_URL+ EMPLOYEE_PROFILE_UPDATE + this.props.match.params.id,{
      method: 'post',
  ...
  async updatePassport(e){
    e.preventDefault();
    const {passport_no,children,spouse,phone,religion,nationality,marrital_status} = this.state;
  ...
  async updateTaxInfo(e){
      e.preventDefault();
      const {paymenttype,salarytype,salary,tapacno,scpacno, scpcon} = this.state;
      ...
      //   if(salarytype === ''){
      //       this.setState({salarytypeError : 'Field is required!.'});
      //       error = true;
      //   }
      ...
      var fetchData = await fetch(API_URL + USER_PROFILE_TAX_UPDATE,{
          method: 'post',
          headers:{'content-type': 'application/json'},
          body: JSON.stringify(data)
        }).then(res =>res.json());
  ...
  async changeEmergency(i, e){
   ...
   render() {
     const {doj,father,name,email,address,mobile,designation,pincode,state,country,dob,sex,nameError,emailError,addressError,mobileError,fatherError,designationError,pincodeError,stateError,dojError,countryError,dobError,sexError,posts,employee, facebook, facebookError, twitter, twitterError, github, githubError, linkedin, linkedinError, alert,message,msgType, passport_no,children,spouse,expiry_date,phone,religion,nationality,marrital_status,personal_info,priname,prirelation,priphone,priphone2,secname,secrelation,secphone,secphone2,prinameError,prirelationError,priphoneError,priphone2Error,secnameError,secrelationError,secphoneError,secphone2Error,bankname,
     account_no,ifsc_code,pan_no, salarytype, salarytypeError, salary, salaryError,paymenttype,paymenttypeError,tapacno,tapacnoError,scpacno,scpacnoError,bnameError,
     ifscError,banknoError, scpcon,scpconError,foreigner, emergency,aleave,raleave} = this.state;
                             ...
                             <div className="col-md-7">
                               <ul className="personal-info">
                                 ...
                                 <li>
                                   ...
                                   <div className="text text-info">{employee.remain_holiday}</div>
                                 </li>
                               </ul>
                             </div>
                           </div>
                       ...
                       <form>
                         <div className="row">
                           <div className="col-sm-4">
                             <div className="form-group">
                               <label className="col-form-label">Salary Type <span className="text-danger">*</span></label>
                         
                               <select className="form-control" value={salarytype} onChange={this.changeSalaryType}>
                               ...
                               {
                                   salarytypeError &&
                                   <p className="text-danger">salarytypeError</p>
                               }
                             </div>
                           </div>
                           <div className="col-sm-4">
                             <div className="form-group">
                               ...
                               <div className="input-group">
                                 ...
                                 <input type="text" className="form-control" placeholder="Type your salary amount" value={salary} onChange={this.changeSalary}/>
                                 {
                                   salaryError &&
                           ...
                           <div className="col-sm-4">
                             <div className="form-group">
                               ...
                               <select className="form-control" value={paymenttype} onChange={this.changePaymentType}>
                             ...
                             {
                                paymenttypeError &&
                                <p className="text-danger">paymenttypeError</p>
                             }
                           </div>
                         </div>
                         {
                          ...
                          <div>
                             <hr />
                               <h3 className="card-title"> Tax and Fund Contribution </h3>
                               <div className="row">
                                 <div className="col-sm-4">
                                   <div className="form-group">
                                     <label className="col-form-label">TAP A/C no</label>
                                     <input type="text" className="form-control" placeholder="Type your salary amount" value={tapacno} onChange={this.changeTapAcNo}/>
                                      {
                                      tapacnoError &&
                                      <p className="text-danger">{tapacnoError}</p>
                                      }
                                   </div>
                                 </div>
                                 <div className="col-sm-4">
                                   <div className="form-group">
                                     <label className="col-form-label">SCP A/C no. <span className="text-danger">*</span></label>
                                     <input type="text" className="form-control" placeholder="Type your salary amount" value={scpacno} onChange={this.changeScpAcNo}/>
                                      {
                                      scpacnoError &&
                                      <p className="text-danger">{scpacnoError}</p>
                                      }
                                   </div>
                                 </div>
                               </div>
                           ...
                           <div className="row">
                             <div className="col-sm-4">
                               <div className="form-group">
                                 ...
                                 <input type="text" className="form-control" placeholder="Type your salary amount" value={this.state.tapcon} disabled/>
                               </div>
                             </div>
                             <div className="col-sm-4">
                               <div className="form-group">
                                 <label className="col-form-label">SCP Contribution<span className="text-danger">*</span></label>
                                 <input type="text" className="form-control" placeholder="Scp contribution %" value={scpcon} onChange={this.changeScpcon}/>
                                 {
                                  scpconError  &&
                                  <p className="text-danger">{scpcon}</p>
                                 }
                               </div>
                             </div>
                             <div className="col-sm-4">
                         ...
                         <div className="submit-section"><button className="btn btn-primary submit-btn" type="submit" onClick={this.updateTaxInfo}>Save</button></div>
                       </form>
                     </div>
                   </div>
                 </div>
                     ...
                     <form>
                       <div className="row">
                         <div className="col-md-12">
                           ...
                           <div className="row">
                             ...
                             <div className="col-md-6">
                               <div className="form-group">
                                 <label>Is a Foreigner <span className="text-danger">*</span></label>
                                 <select  className="form-control" value={this.state.foreigner} onChange={this.changeForeigner}>
                                   <option value="">Select one</option>
                                   <option value="1">Yes</option>
                                   <option value="0">No</option>
                                 </select>
                                 {
                                   this.state.foreignerError &&
                                   <p className="text-danger">{this.state.foreignerError}</p>
                                 }
                               </div>
                             </div>
                             ...
                             <div className="col-md-6">
                               <div className="form-group">
                                 ...
                                 <div className="cal-icon">
                                   <input className="form-control" id="dob" type="text" value={dob} />
                                   {
                                      dobError &&
                             ...
                             <div className="col-md-6">
                               <div className="form-group">
                                 ...
                                 <div className="cal-icon">
                                   <input className="form-control" id="doj" type="text" value={doj} />
                                   {
                                      dojError &&
                             ...
                             <div className="col-md-6">
                               <div className="form-group">
                                 <label>No. of Annual Leaves</label>
                                   <input className="form-control" type="number" value={aleave} onChange={this.changeAleave} />
                               </div>
                             </div>
                             <div className="col-md-6">
                               <div className="form-group">
                                 <label>Remaining Annual Leaves</label>
                                   <input className="form-control" type="number" value={raleave} onChange={this.changeRAleave} />
                               </div>
                             </div>
                           </div>
                         </div>
                       ...
                       <div className="row">
                         ...
                         <div className="col-md-6">
                           <div className="form-group">
                             <label>Twitter</label>
                             <input type="text" className="form-control" value={twitter} onChange={this.changeTwitter} />
                           </div>
                         </div>
                         <div className="col-md-6">
                           <div className="form-group">
                   ...
                   <div className="modal-body">
                     <form>
                       ...
                       <div className="add-more ml-2">
                            <a href="#" onClick={this.cloneMember}><i className="fa fa-plus-circle" /> Add Family Members</a>
                       </div>
                       <div className="submit-section">
                 ...
                 <div className="modal-content">
                   ...
                   <div className="modal-body">
                     <form>
                       ...
                       <div className="add-more ml-2">
                               <a href="#" onClick={this.cloneEmergency}><i className="fa fa-plus-circle" /> Add Emergency Contact</a>
                       </div>
                       <div className="submit-section">
